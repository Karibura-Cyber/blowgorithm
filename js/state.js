...
const SHAPE_DEFS = {
  ...
  for_loop:    {w:165,h:50, color:'#4f46e5', fill:'#eef2ff', stroke:'#4f46e5', label:'For i = 0 to 9',  defaultVars:{varName:'i',from:'0',to:'9',step:'1'}},
  while_loop:  {w:165,h:50, color:'#0d9488', fill:'#f0fdfa', stroke:'#0d9488', label:'While x > 0',    defaultVars:{cond:'x > 0'}},
  do_while:    {w:165,h:50, color:'#9333ea', fill:'#faf5ff', stroke:'#9333ea', label:'Do...While x > 0',defaultVars:{cond:'x > 0'}},
